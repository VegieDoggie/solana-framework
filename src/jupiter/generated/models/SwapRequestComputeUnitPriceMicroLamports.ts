...
export function SwapRequestComputeUnitPriceMicroLamportsFromJSON(
  json: any,
): SwapRequestComputeUnitPriceMicroLamports {
  return SwapRequestComputeUnitPriceMicroLamportsFromJSONTyped(json, false);
}

export function SwapRequestComputeUnitPriceMicroLamportsFromJSONTyped(
  json: any,
...
export function SwapRequestComputeUnitPriceMicroLamportsToJSON(
  value?: SwapRequestComputeUnitPriceMicroLamports | null,
): any {
  return value;
}
