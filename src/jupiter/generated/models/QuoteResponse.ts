...
export function QuoteResponseFromJSONTyped(
  json: any,
  ...
  return {
    ...
    "computedAutoSlippage": !exists(json, "computedAutoSlippage")
      ? undefined
      : json["computedAutoSlippage"],
    "platformFee": !exists(json, "platformFee")
      ? undefined
      : PlatformFeeFromJSON(json["platformFee"]),
    "priceImpactPct": json["priceImpactPct"],
    "routePlan": ((json["routePlan"] as Array<any>).map(RoutePlanStepFromJSON)),
    "contextSlot": !exists(json, "contextSlot")
      ? undefined
      : json["contextSlot"],
