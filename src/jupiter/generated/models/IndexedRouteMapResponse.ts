...
export function IndexedRouteMapResponseFromJSON(
  json: any,
): IndexedRouteMapResponse {
  return IndexedRouteMapResponseFromJSONTyped(json, false);
}

export function IndexedRouteMapResponseFromJSONTyped(
  json: any,
...
export function IndexedRouteMapResponseToJSON(
  value?: IndexedRouteMapResponse | null,
): any {
  if (value === undefined) {
    return undefined;
  }
