...
export function SwapRequestFromJSONTyped(
  json: any,
  ...
  return {
    ...
    "wrapAndUnwrapSol": !exists(json, "wrapAndUnwrapSol")
      ? undefined
      : json["wrapAndUnwrapSol"],
    "useSharedAccounts": !exists(json, "useSharedAccounts")
      ? undefined
      : json["useSharedAccounts"],
    "feeAccount": !exists(json, "feeAccount") ? undefined : json["feeAccount"],
    "computeUnitPriceMicroLamports":
      !exists(json, "computeUnitPriceMicroLamports")
        ? undefined
        : SwapRequestComputeUnitPriceMicroLamportsFromJSON(
          json["computeUnitPriceMicroLamports"],
        ),
    "prioritizationFeeLamports": !exists(json, "prioritizationFeeLamports")
      ? undefined
      : SwapRequestPrioritizationFeeLamportsFromJSON(
        json["prioritizationFeeLamports"],
      ),
    "asLegacyTransaction": !exists(json, "asLegacyTransaction")
      ? undefined
      : json["asLegacyTransaction"],
    "useTokenLedger": !exists(json, "useTokenLedger")
      ? undefined
      : json["useTokenLedger"],
    "destinationTokenAccount": !exists(json, "destinationTokenAccount")
      ? undefined
      : json["destinationTokenAccount"],
    "dynamicComputeUnitLimit": !exists(json, "dynamicComputeUnitLimit")
      ? undefined
      : json["dynamicComputeUnitLimit"],
    "skipUserAccountsRpcCalls": !exists(json, "skipUserAccountsRpcCalls")
      ? undefined
      : json["skipUserAccountsRpcCalls"],
...
export function SwapRequestToJSON(value?: SwapRequest | null): any {
  ...
  return {
    ...
    "prioritizationFeeLamports": SwapRequestPrioritizationFeeLamportsToJSON(
      value.prioritizationFeeLamports,
    ),
