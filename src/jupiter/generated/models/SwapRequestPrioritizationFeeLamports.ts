...
export function SwapRequestPrioritizationFeeLamportsFromJSON(
  json: any,
): SwapRequestPrioritizationFeeLamports {
  return SwapRequestPrioritizationFeeLamportsFromJSONTyped(json, false);
}

export function SwapRequestPrioritizationFeeLamportsFromJSONTyped(
  json: any,
...
export function SwapRequestPrioritizationFeeLamportsToJSON(
  value?: SwapRequestPrioritizationFeeLamports | null,
): any {
  return value;
}
