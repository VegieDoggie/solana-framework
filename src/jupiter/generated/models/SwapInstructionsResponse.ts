...
export function SwapInstructionsResponseFromJSON(
  json: any,
): SwapInstructionsResponse {
  return SwapInstructionsResponseFromJSONTyped(json, false);
}

export function SwapInstructionsResponseFromJSONTyped(
  json: any,
  ...
  return {
    "tokenLedgerInstruction": !exists(json, "tokenLedgerInstruction")
      ? undefined
      : InstructionFromJSON(json["tokenLedgerInstruction"]),
    "computeBudgetInstructions":
      ((json["computeBudgetInstructions"] as Array<any>).map(
        InstructionFromJSON,
      )),
    "setupInstructions":
      ((json["setupInstructions"] as Array<any>).map(InstructionFromJSON)),
    "swapInstruction": InstructionFromJSON(json["swapInstruction"]),
    "cleanupInstruction": !exists(json, "cleanupInstruction")
      ? undefined
      : InstructionFromJSON(json["cleanupInstruction"]),
    "addressLookupTableAddresses": json["addressLookupTableAddresses"],
  };
}

export function SwapInstructionsResponseToJSON(
  value?: SwapInstructionsResponse | null,
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    "computeBudgetInstructions":
      ((value.computeBudgetInstructions as Array<any>).map(InstructionToJSON)),
    "setupInstructions":
      ((value.setupInstructions as Array<any>).map(InstructionToJSON)),
