...
import { Configuration, ConfigurationParameters } from "./generated/index.ts";
...
export const parseAddressLookupTableAccounts = async (
  ...
  while (true) {
    try {
      const addressLookupTableAccountInfos = await connection
...
export const parseSwapInstructions = (
